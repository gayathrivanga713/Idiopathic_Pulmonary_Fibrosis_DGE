...
with open("C:/Users/gayat/downloads/GSE150910_gene-level_count_file.csv") as csvfile:
...
output_file = "C:/Users/gayat/OneDrive/Desktop/output/upregulated_DEGs.csv"
...
sns_plot.savefig("C:/Users/gayat/OneDrive/Desktop/output/heatmap.pdf")
...
# plt.savefig(f"C:/Users/gayat/OneDrive/Desktop/output/{gene_to_plot}_expression_bar.pdf")
plt.show()
...
# plt.savefig(f"C:/Users/gayat/OneDrive/Desktop/output/{gene_to_plot}_expression_scatter.pdf")
plt.show()
...
# sns_plot.savefig("C:/Users/gayat/OneDrive/Desktop/output/degs_correlation_heatmap.pdf")
plt.show()